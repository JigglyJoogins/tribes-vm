...
-- Server Information
ServerSettings.Description = "Unreleased Map Testing"
...
ServerSettings.MapRotation.addCustom("TrCTF-DesertedValley2")
-------------- Arena --------------
-- ServerSettings.MapRotation.addCustom("TrArena-Walledin")
ServerSettings.MapRotation.addCustom("TrArena-Arenaxd")
